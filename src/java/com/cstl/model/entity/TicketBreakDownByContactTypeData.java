 ...
 *
 * @author Tuyen
 * Data about Break Down By Contact Type Tickets Report Data
 */
public class TicketBreakDownByContactTypeData{
    private LinkedHashMap<String, Integer> data;
    private LocalDate startDate;
    private LocalDate endDate;
    
    public TicketBreakDownByContactTypeData(LocalDate startDate, LocalDate endDate)
    {
